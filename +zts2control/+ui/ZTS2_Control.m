...
%             this.build();
        ...
        function initComm(this)
            ...
            this.uiCommGratingStage.setDevice( ...
             zts2control.device.InlineGSLogical(...
                'fhGet', @()this.apiGratingStage.getIsConnected(), ...
                'fhSet', @(lVal) mic.Utils.tern(lVal, ...
                                @()this.apiGratingStage.connect(),...
                                @()this.apiGratingStage.disconnect()), ...
                'fhIsInitialized', @()this.apiGratingStage.getIsReferenced(-1), ...
                'fhInitialize', @()this.apiGratingStage.reference(-1), ...
             )...
            )
