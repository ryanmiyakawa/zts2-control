classdef ZTS2_Control < mic.Base
    ...
    properties
        ...
        cTurningMirrorStageLocation  = 'network:sn:MCS2-00005709';
        ...
        % Stages (Component directory: https://docs.google.com/spreadsheets/d/1XkIcECUzaHNqkPAyfS-WL9XS1frPkNoSe0MANP7GDgw/edit#gid=0)
        uiTurningMirrorStage
        uiPinholeStage
        uiWaferStage
        uiGratingStage
        uiDiodeStage
        ...
        uiPositionRecallerTurningMirrorStage
        uiPositionRecallerPinholeStage
        uiPositionRecallerWaferStage
        uiPositionRecallerGratingStage
...
%             this.build();
        ...
        function initUi(this)
            ...
            % Init stages:
            this.uiTurningMirrorStage = micPlus.ui.stage.MultiAxisStage( ...
                'clock', this.clock, ...
                'cName', 'turning-mirror-stage', ...
                'cLabel', 'Turning Mirror Stage', ...
                'dNumChannels', 2, ...
                'ceStagelabels', {'Rx', 'Ry'}, ...
                'cConfigBasePath',  this.cConfigPath, ...
                'deviceAPI', smaract.MCS2('cLocation', this.cTurningMirrorStageLocation, 'dNumChannels', 2) ...
            );

            this.uiPinholeStage = micPlus.ui.stage.MultiAxisStage( ...
                'clock', this.clock, ...
                'cName', 'pinhole-stage', ...
                ...
                'ceStagelabels', {'X', 'Y'}, ...
                'cConfigBasePath',  this.cConfigPath, ...
                'deviceAPI', smaract.MCS2('cLocation', this.cPinholeStageLocation, 'dNumChannels', 2) ...
            );

            this.uiWaferStage = micPlus.ui.stage.MultiAxisStage( ...
                'clock', this.clock, ...
                'cName', 'wafer-stage', ...
                'cLabel', 'Wafer Stage', ...
                'dNumChannels', 3, ...
                'ceStagelabels', {'X', 'Y', 'Z'}, ...
                'cConfigBasePath',  this.cConfigPath, ...
                'deviceAPI', smaract.MCS2('cLocation', this.cWaferStageLocation, 'dNumChannels', 3) ...
            );

            this.uiGratingStage = micPlus.ui.stage.MultiAxisStage( ...
                'clock', this.clock, ...
                'cName', 'grating-stage', ...
                ...
                'ceStagelabels', {'X', 'Y'}, ...
                'cConfigBasePath',  this.cConfigPath, ...
                'deviceAPI', smaract.MCS2('cLocation', this.cGratingStageLocation, 'dNumChannels', 2) ...
            );

            this.uiDiodeStage = micPlus.ui.stage.MultiAxisStage( ...
                'clock', this.clock, ...
                'cName', 'diode-stage', ...
                'cLabel', 'Diode Stage', ...
                'dNumChannels', 1, ...
                ...
                'cConfigBasePath',  this.cConfigPath, ...
                'lShowStores', true, ...
                'deviceAPI', smaract.MCS2('cLocation', this.cDiodeStageLocation, 'dNumChannels', 1) ...
            );
           ...
           this.uiDoseMonitor = mic.ui.device.GetNumber(...
            ...
            this.uiPositionRecallerTurningMirrorStage =  micPlus.ui.common.PositionRecaller(...
                'cConfigPath', fullfile(this.cAppPath, '+config'), ...
                'cName', 'pr-turning-mirror', ...
                'cLabel', 'Turning Mirror', ...
                'uiStage', this.uiTurningMirrorStage);

            this.uiPositionRecallerPinholeStage = micPlus.ui.common.PositionRecaller(...
                'cConfigPath', fullfile(this.cAppPath, '+config'), ...
                'cName', 'pr-pinhole', ...
                'cLabel', 'Pinhole', ...
                'uiStage', this.uiPinholeStage);
            
            this.uiPositionRecallerWaferStage = micPlus.ui.common.PositionRecaller(...
                'cConfigPath', fullfile(this.cAppPath, '+config'), ...
                'cName', 'pr-wafer', ...
                'cLabel', 'Wafer', ...
                'uiStage', this.uiWaferStage);

            this.uiPositionRecallerGratingStage = micPlus.ui.common.PositionRecaller(...
                'cConfigPath', fullfile(this.cAppPath, '+config'), ...
                'cName', 'pr-grating', ...
                'cLabel', 'Grating', ...
                'uiStage', this.uiGratingStage);
        ...
        function build(this)
           ...
           this.uiprTargetCoordinates.build(uitFid, dLeft3, 500, 340, 200);
            ...
            this.hpStageControls = uipanel(...
                ...
                'Clipping', 'on',...
                'BorderWidth',0, ... 
                'Position', mic.Utils.lt2lb([10 10 500 590], this.hFigure) ...
            );
            ...
            this.hpPositionRecall = uipanel(...
                ...
                'Clipping', 'on',...
                'BorderWidth', 0, ... 
                'Position',  mic.Utils.lt2lb([510 10 330 590], this.hFigure) ...
                );
            ...
            dHeight = 140;
            dWidth = 310
            this.uiPositionRecallerTurningMirrorStage.build(this.hpPositionRecall, 10, dAxisPos, dWidth, dHeight);
            dAxisPos = dAxisPos + dHeight + dPRSep;

            this.uiPositionRecallerPinholeStage.build(this.hpPositionRecall, 10, dAxisPos, dWidth, dHeight);
            dAxisPos = dAxisPos + dHeight + dPRSep;

            this.uiPositionRecallerWaferStage.build(this.hpPositionRecall, 10, dAxisPos, dWidth, dHeight);
            dAxisPos = dAxisPos + dHeight + dPRSep;

            this.uiPositionRecallerGratingStage.build(this.hpPositionRecall, 10, dAxisPos, dWidth, dHeight);
            dAxisPos = dAxisPos + dHeight + dPRSep;
            ...
            % Build Grating stage
            dAxisPos = this.uiTurningMirrorStage.build(this.hpStageControls, dLeft, dAxisPos, this.dMultiAxisSeparation);
            dAxisPos = this.uiPinholeStage.build(this.hpStageControls, dLeft, dAxisPos, this.dMultiAxisSeparation);
            dAxisPos = this.uiWaferStage.build(this.hpStageControls, dLeft, dAxisPos, this.dMultiAxisSeparation);
            dAxisPos = this.uiGratingStage.build(this.hpStageControls, dLeft, dAxisPos, this.dMultiAxisSeparation);
            dAxisPos = this.uiDiodeStage.build(this.hpStageControls, dLeft, dAxisPos, this.dMultiAxisSeparation);
