...
This overloaded version will also lock reticle conjugate by reading off of
height sensor.

%}

classdef ScanSetupReticleLock < mic.ui.common.ScanSetup
    ...
    methods
        ...
        % Th
        function this = ScanSetupReticleLock(varargin)
